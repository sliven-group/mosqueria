...
<section class="pt-50 pb-50">
	<p class="text-center mb-40">Su carrito de compras está vacía</p>
	<a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="mos__btn mos__btn--primary m-auto ds-block">IR A LA TIENDA</a>
