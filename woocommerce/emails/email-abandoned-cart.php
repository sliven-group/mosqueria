...
<body marginwidth="0" topmargin="0" marginheight="0" offset="0" style="margin:0 auto;">
    ...
    <tr>
      <td align="center" style="padding:0;background: #000;">
        <img src="<?php echo IMAGES . 'emails/foto-email-12.jpg'; ?>" alt="imagen"
          width="282" border="0" style="width:282px;height:auto;display:block;margin: 0 auto;" />
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="20" style="font-size:30px; line-height:30px;">&nbsp;</td>
    </tr>
    <tr>
			<td>
            ...
            <tbody>
              ...
              <?php } ?>
                <tr>
                  ...
                  <td style="text-align:center;"></td>
                  <td style="text-align:center;"><a style="border: 1px solid black;padding: 2px 4px;display: block;border-radius: 2px;font-size: 11px; margin: 0 auto;white-space: nowrap;color:black;font-weight: bold;text-decoration: none;" href="<?php echo home_url('carrito'); ?>" target="_blank" >Comprar ahora</a></td>        
                </tr>
