...
<tr>
	<td align="center" style="padding:0;background: #fff;">
		<img src="<?php echo IMAGES . 'emails/foto-email-9.jpg'; ?>" alt="imagen" width="100%" border="0"	style="width:100%;height:auto;display:block;" />
	</td>
</tr>
...
<tr>
	<td align="center"
		...
		Nos complace darle la bienvenida a nuestro programa de fidelidad, donde podrá acceder a beneficios exclusivos según su nivel de membresía. Ahora usted pertenece al nivel Access y ha recibido 500 puntos de cortesía como obsequio de bienvenida.
	</td>
</tr>
<tr>
	<td height="10" style="font-size:10px; line-height:10px;">&nbsp;</td>
...
<tr>
	<td align="center"
		style="padding: 0 20px 0 20px;font-family:Lato,Arial,sans-serif;font-weight:400;color:#000;text-align:center;font-size:16px;line-height: 21px;">
		Continúe acumulando puntos con cada compra para avanzar de nivel y disfrutar de nuevas recompensas.
	</td>
</tr>
<tr>
	<td height="10" style="font-size:10px; line-height:10px;">&nbsp;</td>
...
<tr>
	<td align="center"
		style="padding: 0 20px 0 20px;font-family:Lato,Arial,sans-serif;font-weight:400;color:#000;text-align:center;font-size:16px;line-height: 21px;">
		Para más información, lo invitamos a ingresar al siguiente enlace:
	</td>
</tr>
<tr>
