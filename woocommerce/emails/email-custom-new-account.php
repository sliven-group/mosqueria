...
<tr>
	<td align="center" style="padding:0;background: #fff;">
		<img src="<?php echo IMAGES . 'emails/foto-email-11.jpg'; ?>" alt="placeholder"
			width="100%" border="0" style="width:100%;height:auto;display:block;" />
	</td>
</tr>
<tr>
...
<tr>
	<td align="center"
		...
		Estimado/a <?php echo $user_first; ?>,
	</td>
</tr>
<tr>
	<td align="center"
		...
		Su cuenta fue creada correctamente. Ahora forma parte de Mosqueira Social Club, donde podrá acceder a beneficios exclusivos solo para miembros.
	</td>
</tr>
<tr>
...
<tr>
	<td align="center"
		style="padding: 0 20px 0 20px;font-family:Lato,Arial,sans-serif;font-weight:400;color:#000;text-align:center;font-size:16px;line-height: 21px;">
		Ingrese a nuestra tienda virtual y comience a acumular puntos.
	</td>
</tr>
<tr>
...
<tr>
	<td align="center"
		...
		<a href="<?php echo home_url('mi-cuenta'); ?>" target="_blank"
			...
			<span style="color: #fff!important;">Ir a mi cuenta</span>
		</a>
	</td>
</tr>
		<tr>
    ...
    <tr>
      <td align="center"
        ...
        <a href="<?php echo home_url('politica-de-privacidad'); ?>" target="_blank"
          style="font-size: 13px; font-family: Lato, Arial, sans-serif;font-weight: 700; color: #000!important; text-decoration: none;">Políticas de privacidad</a>
      </td>
    </tr>
    <tr>
      <td align="center"
