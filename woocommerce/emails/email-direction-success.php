	...
	<table align="center" width="100%" bgcolor="#ffffff" style="max-width:600px;" border="0" cellspacing="0"
		...
		<tr>
			<td align="center"
				...
				Su dirección ha sido guardada correctamente y será utilizada para el envío de sus próximos pedidos.
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center"
				style="padding: 0 20px 0 20px;font-family:Lato,Arial,sans-serif;font-weight:400;color:#000;text-align:center;font-size:16px;line-height: 21px;">
				Gracias por confiar en Mosqueira.
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center"
				...
				<a href="<?php echo home_url(); ?>" target="_blank"
					...
					<span style="color: #fff!important;">Ingresar a la tienda virtual</span>
				</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" style="padding:0;background: #fff;">
				<img src="<?php echo IMAGES . 'emails/foto-email-4.jpg'; ?>" alt="imagen" width="100%" border="0"
