	...
	<table align="center" width="100%" bgcolor="#ffffff" style="max-width:600px;" border="0" cellspacing="0"
		...
		<tr>
			<td align="center"
				...
				Estimado/a, <?php echo $first_name; ?>
			</td>
		</tr>
		<tr>
			<td align="center"
				...
				Para actualizar su contraseña, por favor ingrese al siguiente enlace:
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center"
				...
				<a href="<?php echo $reset_url; ?>" target="_blank"
					...
					<span style="color: #fff!important;">Restablecer contraseña</span>
				</a>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center"
				style="padding: 0 20px 0 20px;font-family:Lato,Arial,sans-serif;font-weight:400;color:#000;text-align:left;font-size:16px;line-height: 21px;text-align: center;">
				Si usted no ha solicitado este cambio, le pedimos que ignore este mensaje. Su contraseña actual permanecerá
				vigente.
			</td>
		</tr>
		<tr>
